...
{
    [Serializable]
    public class QueryTrajectoryState_ResponseMsg : Message
    {
        public const string k_RosMessageName = "control_msgs/QueryTrajectoryState_Response";
        ...
        public QueryTrajectoryState_ResponseMsg()
        {
            this.success = false;
            this.message = "";
        ...
        public QueryTrajectoryState_ResponseMsg(bool success, string message, string[] name, double[] position, double[] velocity, double[] acceleration)
        {
        ...
        public static QueryTrajectoryState_ResponseMsg Deserialize(MessageDeserializer deserializer) => new QueryTrajectoryState_ResponseMsg(deserializer);

        private QueryTrajectoryState_ResponseMsg(MessageDeserializer deserializer)
        {
        ...
        {
            return "QueryTrajectoryState_ResponseMsg: " +
